    ...
    <div className="grid w-full grid-cols-1 gap-3 sm:grid-cols-2">
      {PROMPTS.map((p) => (
        <button
          ...
          className="cursor-pointer rounded-xl border border-zinc-200 bg-white px-4 py-3 text-left transition-colors hover:border-zinc-300 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700 dark:hover:bg-zinc-800"
        >
